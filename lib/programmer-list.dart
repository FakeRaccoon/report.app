...
class ProgrammerReportList extends StatefulWidget {
  final FormModel? formModel;
  final int? employeeId;
  final String? mainFilter;
  final DateTime? fromDate;
  final DateTime? toDate;
  const ProgrammerReportList({
    this.formModel,
    this.employeeId,
    this.mainFilter,
    this.fromDate,
  ...
  @override
  _ProgrammerReportListState createState() => _ProgrammerReportListState();
}

class _ProgrammerReportListState extends State<ProgrammerReportList> {
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 10),
                          Text('Permintaan', style: GoogleFonts.sourceSansPro(color: Colors.grey)),
                          Text(report![index].request!, style: GoogleFonts.sourceSansPro()),
                          SizedBox(height: 10),
